...
import { selectFiles, getFilesAsync } from "../ChatSlice";
import { selectStudents, getAllStudentsAsync } from "../../user/UserSlice";

const CourseCreateModal = ({ open, onClose }) => {
    const dispatch = useDispatch();
    const Files = useSelector(selectFiles) || [];  // Ensure Files is an array, even if null
    const Students = useSelector(selectStudents) || [];  // Ensure Students is an array, even if null
